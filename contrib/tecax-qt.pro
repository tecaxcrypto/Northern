...
RESOURCES += src/qt/tecax.qrc src/qt/tecax_locale.qrc

TRANSLATIONS += src/qt/locale/tecax_bg.ts \
                src/qt/locale/tecax_de.ts \
                src/qt/locale/tecax_en.ts \
                src/qt/locale/tecax_es.ts \
                src/qt/locale/tecax_fi.ts \
                src/qt/locale/tecax_fr.ts \
                src/qt/locale/tecax_it.ts \
                src/qt/locale/tecax_ja.ts \
                src/qt/locale/tecax_pl.ts \
                src/qt/locale/tecax_pt.ts \
                src/qt/locale/tecax_ru.ts \
                src/qt/locale/tecax_sk.ts \
                src/qt/locale/tecax_sv.ts \
                src/qt/locale/tecax_vi.ts \
                src/qt/locale/tecax_zh_CN.ts \
                src/qt/locale/tecax_zh_TW.ts
