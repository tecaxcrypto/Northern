...
Setup
---------
Configuring the github-merge tool for the Tecax repository is done in the following way:

    git config githubmerge.repository tecax/tecax
...
A script to optimize png files in the Tecax
