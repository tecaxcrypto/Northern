...
The Tecax Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tecax Core project, and is not to be
confused with overall Tecax Network Protocol consensus changes.

Whether a pull request is merged into Tecax Core rests with the project merge
...
Patches that change Tecax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tecax consensus, it must have been
