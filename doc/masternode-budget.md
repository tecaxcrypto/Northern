...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<tecax_address\> \<monthly_payment_tecax\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<tecax_address\> \<monthly_payment_tecax\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` TECAX.
