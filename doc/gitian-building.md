...
```bash
    ...
    From https://github.com/northern/northern
...
For example:
```bash
URL=https://github.com/konez2k/northern.git
...
[northern/gitian.sigs](https://github.com/northern/gitian.sigs/) repository, or if that's not possible to create a pull
request.
