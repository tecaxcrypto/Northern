...
In order to support loading of multiple wallets in tecax-qt, a few changes in the UI architecture will be needed.
...
----------------------
tecax.cpp is the entry point into tecax-qt, and as such, will require some minor modifications to provide hooks for
