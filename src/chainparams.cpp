...
// Copyright (c) 2017 The Tecax developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1531014258, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        // Tecax BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Tecax: 1 day
        nTargetSpacing = 2 * 60;  // Tecax: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // assert(hashGenesisBlock == uint256("0x000008467c3a9c587533dea06ad9380cded3ed32f9742a6c0c1aebc21bf2bc9b"));
        ...
        // Testnet Tecax addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet Tecax script addresses start with '5' or '6'
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Tecax: 1 day
        nTargetSpacing = 2 * 60;        // Tecax: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1516926684;
