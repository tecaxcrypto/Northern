...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tecax Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tecax"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Tecax Core help message to get a list with possible Tecax command-line options"));
