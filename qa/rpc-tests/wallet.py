...
#   c) node1 mines 32 blocks, so now node 0 has 500000TECAX, node 1 has 4250TECAX, node2 has none.
#   d) node0 sends 601 TECAX to node2, in two transactions (301 TECAX, then 300 TECAX).
